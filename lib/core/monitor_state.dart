...
double vehicleSpeed = 0.0;
  ...
  int consecutiveDistractedFrames = 0;     // frames of sustained yaw > threshold
  int consecutiveNotDistractedFrames = 0;  // frames of recovery
  ...
  void resetCalibration() {
    ...
    consecutiveNotDistractedFrames = 0;
