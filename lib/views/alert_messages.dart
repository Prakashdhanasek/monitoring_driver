 ...
 static String unauthorized(AlertLang lang) => _pick(lang,
  ...
  static String breakReminder(AlertLang lang, int index) {
    switch (index % 5) {
      case 0:
        return _pick(lang,
            en: 'Time for a Break! Pull over safely and rest for a few minutes.',
            hi: 'ब्रेक का समय! सुरक्षित रूप से रुकें और कुछ मिनट आराम करें।',
            ml: 'ബ്രേക്ക് സമയം! സുരക്ഷിതമായി നിർത്തി കുറച്ച് മിനിറ്റ് വിശ്രമിക്കുക.',
            ta: 'இடைவேளை நேரம்! பாதுகாப்பாக நிறுத்தி சில நிமிடங்கள் ஓய்வெடுங்கள்.');
      case 1:
        return _pick(lang,
